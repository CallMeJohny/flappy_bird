...
def run_game():
    ...
    bg_image = pygame.image.load("images/city-bg.png")
    bg_image = pygame.transform.scale(bg_image, (1600, 768))
    gravity = -12
    top_towers = []
    bottom_towers = []
    last_tower_passed = 0
    ...
    while not ended:
        ...
        draw_game_state(
            cloud_rect, cloud_image, 
            bg_rect, bg_image, 
            top_towers, bottom_towers, 
            HERO, 
            score
            )
        FPS_CLOCK.tick(FPS)
...
def draw_bg(cloud_rect, cloud_image, bg_rect, bg_image):
...
def draw_game_state(cloud_rect, cloud_image, bg_rect, bg_image, top_towers, bottom_towers, HERO, score):
    draw_bg(cloud_rect, cloud_image, bg_rect, bg_image)
